  ...
  return (
    <div className="fp">
      <div className="fpItem">
        ...
        <span className="fpPrice">Starting from Rs 22,000</span>
      ...
      <div className="fpItem">
        ...
        <span className="fpPrice">Starting from Rs 30,000</span>
        <div className="fpRating">
          <button>9.3</button>
      ...
      <div className="fpItem">
        <img
          src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/0d/00/ab/hotel-exterior.jpg?w=700&h=-1&s=1"
          alt=""
          className="fpImg"
        />
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">The Pride Hotel</span>
